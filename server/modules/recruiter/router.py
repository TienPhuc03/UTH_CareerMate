...
from server.core.dependencies import require_recruiter
...
from server.modules.jobs.schemas import JobResponse, JobCreate, JobUpdate
from server.modules.applications.schemas import ApplicationResponse
